...
export const MARKETS = [
  {
    ...
    name: 'Albert Heijn',
    color: '#00A0E2',
    ctaTitle: 'Albert Heijn Bonus: 1+1 Gratis & tot 50% Korting | Vandaag Actueel',
  ...
  },
  {
    ...
    name: 'Jumbo',
    color: '#FFD700',
    ctaTitle: 'Jumbo Aanbiedingen: Goedkoper dan AH? Vergelijk & Bespaar | Vandaag Actueel',
  ...
  },
  {
    ...
    name: 'Aldi',
    color: '#00205B',
    ctaTitle: 'Aldi Aanbiedingen: 15-25% Goedkoper dan AH & Jumbo | Vandaag Actueel',
