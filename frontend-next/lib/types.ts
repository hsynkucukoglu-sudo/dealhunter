...
export const MARKETS = [
  {
    ...
    name: 'Albert Heijn',
    color: '#00A0E2',
    ctaTitle: 'Bonus Aanbiedingen Albert Heijn | AH Deals & 1+1 Gratis Acties Deze Week',
    description: 'Bonus aanbiedingen Albert Heijn: wekelijks 50–80 deals met tot 50% korting — 1+1 gratis, 2e halve prijs en bonus aanbiedingen op vlees, zuivel en dranken. Dagelijks bijgewerkt, geen app nodig.',
  ...
  },
  {
    ...
    name: 'Dirk',
    color: '#C8102E',
    ctaTitle: 'Dirk van den Broek Aanbiedingen Deze Week | Laagste Vleesprijzen van NL',
