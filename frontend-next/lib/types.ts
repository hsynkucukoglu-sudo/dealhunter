...
export const MARKETS = [
  ...
  },
  {
    ...
    name: 'Hoogvliet',
    color: '#E30613',
    ctaTitle: '🔴 Hoogvliet Aanbiedingen Deze Week | Folder & Beste Deals',
    description: '✅ Alle actuele Hoogvliet aanbiedingen en beste deals van deze week op één plek. Dagelijks bijgewerkt. Bespaar slim op je boodschappen bij Hoogvliet supermarkt!',
    keywords: 'hoogvliet aanbiedingen, hoogvliet folder, hoogvliet deals, hoogvliet aanbieding deze week, hoogvliet korting, hoogvliet actie',
  },
  {
    slug: 'vomar',
    name: 'Vomar',
    color: '#FF6600',
    ctaTitle: '🟠 Vomar Aanbiedingen Deze Week | Goedkope Deals & Folder',
