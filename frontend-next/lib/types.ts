...
export const MARKETS = [
  ...
  },
  {
    ...
    name: 'Jumbo',
    color: '#FFD700',
    ctaTitle: 'Jumbo Aanbiedingen Deze Week | Folder, Deals & Weekaanbiedingen (Actueel)',
    description: 'Alle Jumbo aanbiedingen deze week op één plek — 1+1 gratis, 2e halve prijs en weekdeals. Aanbiedingen Jumbo dagelijks bijgewerkt. Jumbo gemiddeld 2-5% goedkoper dan AH. Vergelijk direct.',
    keywords: 'jumbo aanbiedingen, aanbiedingen jumbo, jumbo folder, jumbo deals, jumbo week aanbieding, jumbo aanbieding deze week, jumbo 1+1, jumbo korting, jumbo weekaanbieding',
  },
  {
    slug: 'lidl',
    name: 'Lidl',
  ...
  },
  {
    ...
    name: 'Dirk',
    color: '#C8102E',
    ctaTitle: 'Dirk van den Broek Aanbiedingen Deze Week | Laagste Vleesprijzen NL',
    description: 'Aanbiedingen Dirk van den Broek deze week — laagste vleesprijzen van Nederland, scherpe dranken- en groentedeals. Alle dirk aanbiedingen dagelijks bijgewerkt. Direct vergelijken zonder folder.',
    keywords: 'dirk van den broek aanbiedingen, aanbiedingen dirk van den broek, aanbieding dirk van den broek, dirk aanbiedingen, dirkvandenbroek folder, dirk van den broek folder, dirk van de broek aanbiedingen, aanbiedingen dirk van de broek, aanbiedingen dirk, dirk folder, dirk deals, dirk aanbieding deze week',
  },
  {
    slug: 'aldi',
    name: 'Aldi',
  ...
  },
  {
    ...
    name: 'DekaMarkt',
    color: '#006633',
    ctaTitle: 'DekaMarkt Aanbiedingen Deze Week | Actuele Combi-deals & Kortingen',
    description: 'Aanbiedingen DekaMarkt deze week — combi-deals, 1+1 gratis en verse producten tot 40% korting. Aanbieding DekaMarkt dagelijks bijgewerkt, direct vergelijken zonder folder bladeren.',
    keywords: 'aanbiedingen dekamarkt, dekamarkt aanbiedingen, dekamarkt aanbiedingen deze week, aanbieding dekamarkt, dekamarkt aanbieding, dekamarkt folder, dekamarkt deals, dekamarkt actie, dekamarkt aanbieding deze week, dekamarkt korting, dekamarkt weekaanbieding',
  },
  {
    slug: 'coop',
    name: 'Coop',
