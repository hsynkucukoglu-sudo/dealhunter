export const MARKET_CONTENT: Record<string, string> = {
  'albert-heijn': `
<h2>Over Albert Heijn Aanbiedingen</h2>
<p>Albert Heijn is de grootste supermarktketen van Nederland met meer dan 1.000 filialen. De wekelijkse <strong>AH Bonus-aanbiedingen</strong> wisselen elke woensdag en bieden kortingen tot 50% op honderden producten — van zuivel en vlees tot dranken en verzorgingsproducten.</p>
<h3>Hoe werkt de AH Bonus?</h3>
<p>De Bonuskaart is gratis en geeft toegang tot alle weekdeals: <strong>1+1 gratis</strong>, <strong>2e halve prijs</strong> en procentuele kortingen op versproducten. Via de AH-app ontvang je bovendien persoonlijke kortingscoupons op producten die je vaak koopt. Zonder Bonuskaart betaal je de normale adviesprijs.</p>
<h3>Wanneer zijn AH-aanbiedingen het voordeligst?</h3>
...
`,
  ...
  'aldi': `
<h2>Over Aldi Aanbiedingen & Deals</h2>
<p><strong>Aanbiedingen Aldi</strong> vind je hier wekelijks bijgewerkt. Aldi behoort tot de <strong>goedkoopste supermarkten van Nederland</strong>. Door een slim concept met voornamelijk huismerken en een efficiënt distributiesysteem liggen de prijzen gemiddeld <strong>20-30% lager dan bij Albert Heijn en Jumbo</strong>. De wekelijkse <strong>Aldi aanbiedingen</strong> starten elke maandag.</p>
<h3>Wat maakt Aldi zo goedkoop?</h3>
<p>Aldi werkt met een beperkt assortiment van circa 2.000 producten (vs. 30.000+ bij AH) en verkoopt voornamelijk eigen merken: <strong>Mamia</strong> (luiers), <strong>Tandil</strong> (wasmiddel), <strong>Bellarom</strong> (koffie) en <strong>River</strong> (cola). Onafhankelijke tests tonen aan dat deze A-merk-alternatieven vaak vergelijkbare kwaliteit bieden.</p>
<h3>Non-food Aldi acties: waterbaan, kleding, elektronica</h3>
