...
const DEALS = [
  {
    ...
    items: [
      ...
      { name: 'Essent',           tagline: 'Grootste energieleverancier van NL', cta: 'Vergelijk tarief', color: '#E2001A', url: DC('https://lt45.net/c/?si=9787&li=1437653&wi=420902', 'https://www.essent.nl/') },
      { name: 'energiedirect',    tagline: 'Gas & stroom voordelig geregeld',    cta: 'Vergelijk tarief', color: '#0F9D58', url: DC('https://lt45.net/c/?si=924&li=55221&wi=420902', 'https://www.energiedirect.nl/') },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Minisforum FR',   tagline: 'Mini PC\'s & AI workstations',  cta: 'Bekijk aanbod',  color: '#1A1A2E', url: DC('https://glp8.net/c/?si=20763&li=1880752&wi=420902', 'https://minisforum-store.com/fr/') },
