...
const DEALS = [
  {
    ...
    items: [
      ...
      { name: 'Vattenfall',   tagline: 'Groen & betrouwbaar',      cta: 'Vergelijk tarief', color: '#1B6B3A', url: DS('16070', '21044',   'https://www.vattenfall.nl/energie/stroom-en-gas/') },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Smartbox & Bongo',   tagline: 'Belevenis cadeaus & uitjes', cta: 'Bekijk cadeaus', color: '#E10065', url: DS('16070', '21185',   'https://www.smartbox.com/nl-nl/cadeaubon') },
      ...
      { name: 'Leukstetickets',     tagline: 'Concerten, shows & events',  cta: 'Bekijk tickets', color: '#9C27B0', url: DS('16070', '15805',   'https://www.leukstetickets.nl/') },
    ],
  },
  {
    id: 'wonen',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Plein.nl',          tagline: 'Online drogist & gezondheid', cta: 'Bekijk aanbod',    color: '#00BCD4', url: DS('16070', '3366',   'https://www.plein.nl/') },
    ],
  },
  {
    id: 'auto',
    category: '🚗 Auto & Rijden',
    items: [
      { name: 'XLLease',    tagline: 'Private lease aanbiedingen', cta: 'Bekijk lease deals', color: '#1565C0', url: DS('16070', '20255', 'https://www.xllease.nl/') },
      { name: 'DutchLease', tagline: 'Zakelijk & privé lease',     cta: 'Bekijk lease deals', color: '#0D47A1', url: DS('16070', '20456', 'https://www.dutchlease.nl/') },
      { name: 'Eonon',      tagline: 'Autoradio & multimedia',     cta: 'Bekijk aanbod',      color: '#E65100', url: AW(2471,   'https://www.eonon.com/') },
    ],
  },
]
...
const FEATURED_BRANDS = [
  ...
  { name: 'Ziggo',             category: 'telecom',     color: '#D70034' },
  { name: 'CheapTickets',      category: 'reizen',      color: '#D9251D' },
  { name: 'XLLease',           category: 'auto',        color: '#1565C0' },
]
