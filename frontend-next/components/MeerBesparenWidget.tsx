...
const DEALS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Emma Matras',  tagline: 'Topmatrassen online',       cta: 'Bekijk matrassen', color: '#1A1A1A', url: 'https://lt45.net/c/?si=12959&li=1571690&wi=420902' },
      { name: 'Westwing',     tagline: 'Design & wooninspiratie',   cta: 'Bekijk collectie', color: '#2D2D2D', url: 'https://jdt8.net/c/?si=17294&li=1747070&wi=420902' },
  ...
  },
  {
    ...
    items: [
      { name: 'H&M',        tagline: 'Mode voor iedereen',        cta: 'Bekijk collectie', color: '#E4002B', url: 'https://jf79.net/c/?si=17004&li=1733397&wi=420902' },
      { name: 'La Redoute', tagline: 'Franse mode & interieur',   cta: 'Bekijk collectie', color: '#C41230', url: 'https://fr135.net/c/?si=16029&li=1689932&wi=420902' },
      { name: 'Spartoo',    tagline: 'Schoenen & accessoires',    cta: 'Bekijk schoenen',  color: '#FF6600', url: 'https://lt45.net/c/?si=11714&li=1519416&wi=420902' },
      { name: 'Babubas',    tagline: 'Babykleding & -spullen',    cta: 'Bekijk aanbod',    color: '#E879A0', url: 'https://glp8.net/c/?si=20760&li=1880744&wi=420902' },
    ],
  },
]
