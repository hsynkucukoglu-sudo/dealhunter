      ...
      {isCartOpen && (
        <>
          ...
          <motion.div
            ...
            style={{ background: '#FAF6F0', boxShadow: '-8px 0 30px rgba(0,0,0,0.08)' }}
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              {items.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center space-y-4">
                  ...
                  <p className="text-xs text-center max-w-[220px]" style={{ color: '#9C9389' }}>{t.cartEmptyDesc}</p>
                </div>
              ) : (
                items.map(item => (
                  <motion.div
              ...
              <div className="p-5 space-y-3" style={{ borderTop: '1px solid #E0D8CE' }}>
                ...
                <div className="flex gap-2 pt-1">
                  ...
                  <motion.button
                    ...
                    style={{ background: 'linear-gradient(135deg, #25D366, #128C7E)', boxShadow: '0 4px 14px -3px rgba(37, 211, 102, 0.4)' }}
                  >
