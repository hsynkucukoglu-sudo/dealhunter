...
export function SiteFooter() {
  return (
    <footer
      style={{
        background: '#F5EDE3',
        borderTop: '1px solid rgba(228, 190, 183, 0.5)',
      }}
      className="mt-16 w-full"
    >
      <div className="max-w-[1280px] mx-auto px-4 md:px-16 pt-14 pb-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p
              ...
              style={{ color: '#6B6259', fontFamily: 'Hanken Grotesk', maxWidth: 220 }}
            >
              Vergelijk wekelijkse aanbiedingen van alle grote supermarkten in Nederland.
              Bespaar elke week slim.
            </p>
            <div className="flex items-center gap-3">
              <a
                ...
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = '#E33D26'; (e.currentTarget as HTMLElement).style.color = 'white' }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = 'rgba(228,190,183,0.4)'; (e.currentTarget as HTMLElement).style.color = '#6B6259' }}
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                { href: '/klantenkaarten', label: '🃏 Digitale klantenkaarten' },
        ...
        <div
          ...
          style={{ borderTop: '1px solid rgba(228, 190, 183, 0.5)', color: '#9C9389', fontFamily: 'JetBrains Mono' }}
        >
          <span>© {new Date().getFullYear()} DealHunter4U — Alle rechten voorbehouden.</span>
          <span className="hidden sm:inline" style={{ color: '#C9C1B6' }}>
            Prijzen kunnen afwijken — controleer altijd bij de supermarkt.
          </span>
        </div>
      </div>
    </footer>
