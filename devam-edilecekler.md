...
- [ ] **Öncelik sıralaması için `PARA_KAZANMA_YOLHARITASI.md`'ye bak** — Faz A/B/C detaylı, gelir kanalı tablosu ve riskler orada. Özet: önce AdSense re-review + CTR ölçümü + energie içerik kümesi, yeni büyük iş başlatma.
