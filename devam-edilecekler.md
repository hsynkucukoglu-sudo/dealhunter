...
- [x] **Faz B başladı — 2 yeni karşılaştırma yazısı**: "Is Dirk Goedkoper dan Aldi?" (562 kelime) ve "Is Plus Goedkoper dan Jumbo?" (587 kelime) — roadmap'in "kanıtlanmış tek format" bulgusuna göre (albert-heijn-vs-jumbo-vs-lidl 25 tıklama ile sitenin en çok tıklanan sayfası). Plus özellikle seçildi çünkü GSC'de 3684 gösterim/1 tıklama ile kendi market sayfası zayıf performans gösteriyor — ikinci bir içerik açısı deneniyor. 44 toplam blog yazısı, 42→44. Commit `4a4570c`, canlıda doğrulandı.
